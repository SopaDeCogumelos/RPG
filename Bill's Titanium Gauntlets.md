# Bill's Titanium Gauntlets
*Designed and built by Vince*

<img src="Gemini_Generated_Image_c65iijc65iijc65i.png">

### **Dano (Ofensivo):** Força + 2 (Dano Letal).
  - ***Por que:** Socos ingleses dão Força+1. Isso é muito mais pesado e duro. Transforma o dano de Contusão (soco normal) em Letal (quebra ossos/rasga tecido).*

### **Defesa (Passiva):** +1 dado em rolagens de Parry desarmado.
  - ***Por que:** Você pode usar o antebraço blindado para bloquear facas ou garras sem se cortar.*

### **Penalidade:** -2 dados em qualquer teste de Destreza que envolva manipulação fina (digitar, abrir fechaduras, pegar moedas, usar celular)

### Habilidade Especial: "Newton's Denial"
- **Efeito:** O usuário não sofre dano ao socar superfícies duras (paredes de concreto, portas de aço, crânios de vampiros com Fortitude).
- **Regra:** Se o jogador usar potência máxima para socar algo que normalmente quebraria sua mão, a manopla absorve o impacto. Sem ela, ele tomaria 1 ou 2 níveis de dano de contusão pelo próprio esforço.

### Notas do Vince:

1. **Fabricação:**
   1. **Corte:** Laser de fibra óptica (o AR500 é duro demais para serras comuns).
